...
> **Note:** The Splunk SDK for JavaScript v1.7.0 requires Node.js version 0.10.x, or 0.12.x. IO.js is not formally supported, but it should work as of `v1.7.0` of the SDK.
