...
echo "     \033[0;33m 3) There shouldn't be any whitespace around , (comma) while running the multiple modules. \033[0m"
echo "     \033[0;33m 4) There shouldn't be any whitespace around | (pipe) while running the multiple tests. \033[0m"
echo ""