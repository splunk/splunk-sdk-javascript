...
(function() {
     ...
     *    - `required` (_boolean_): Whether this field is multivalued.
     ...
     *    - `inputFieldMappings` (_string_): TODO: need a label
     *
     ...
     *    - `objectsToGroup` (_string_): TODO: need a label
    ...
    root.DataModelObject = Class.extend({
         ...
         *     - `baseSearch` (_string_): (Optional) TODO: need a label; exclusive to BaseSearch
         *     - `groupByFields` (_string_): (Optional) TODO: need a label; exclusive to BaseTransaction
         *     - `objectsToGroup` (_string_): (Optional) TODO: need a label; exclusive to BaseTransaction
         *     - `maxSpan` (_string_): (Optional) TODO: need a label; exclusive to BaseTransaction
         *     - `maxPause` (_string_): (Optional) TODO: need a label; exclusive to BaseTransaction
         *
         *
         * @param {splunkjs.Service.DataModel} parentDataModel The `DataModel` that owns this data model object.
         *
        ...
        init: function(props, parentDataModel) {
            ...
            // TODO: need some tests to hit these properties; add to init docs
