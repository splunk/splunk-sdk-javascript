...
(function() {
    ...
    root.DataModel = Service.Entity.extend({
        ...
        update: function(callback) {
            ...
            // TODO: some of these properties might not be set/get correctly
            var props = {
                acceleration: {
                    enabled: this.properties().accelerationEnabled,
                    earliest_time: this.properties().earliestTime,
                    cron_schedule: this.properties().cronSchedule
                }
            };
