...
(function() {
    ...
    root.DataModelObject = Class.extend({
         ...
         * TODO: docs
         *
         * Returns a JavaScript object representing a pivot specification
         */
        createPivotSpec: function() {
            // TODO: add in some of the other fields
            var ret = {
                columns: [],
                rows: [],
                filters: [],
            ...
            if (this.dataModel().isAccelerated()) {
                ret.accelerationNamespace = this.dataModel().name;
            }
            else {
                ret.accelerationNamespace = null;
            }

            var that = this;
            // TODO: docs
            ret.dataModelObject = function() {
                return that;
            };
            // TODO: docs
            ret.setAccelerationJob = function(sid) {
                if (!sid) {
            ...
            // TODO: docs
            ret.setAccelerationNamespace = function(ns) {
