...
(function() {
     ...
     *    - `_types` (_array_): Possible values for `type`.
     ...
     *    - `expression` (_string_): TODO: label
     *
     * The Rex and GeoIP types have an additional property:
     *    - `inputField` (_string_): TODO: label
     *
     * The Lookup type has additional properties:
     *    - `lookupName` (_string_): TODO: label
     *    - `inputFieldMappings` (_string_): TODO: label
     *
    ...
    root.PivotSpecification = Class.extend({
         ...
         *
         * TODO: docs, example
         * TODO: investigate what's actually going on, so docs make sense
         *
    ...
    root.DataModelObject = Class.extend({
         ...
         *
         * TODO: doc non-common properties (conditional properties)
         *
         * @param {splunkjs.Service.DataModel} parentDataModel The `DataModel` that owns this data model object.
         *
