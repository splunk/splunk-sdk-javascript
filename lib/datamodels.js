...
(function() {
    ...
    root.PivotSpecification = Class.extend({
         ...
         * @param {String} comparisonOp The comparison, see `this.comparisons` for valid comparisons, based on type.
         ...
         *    - `step` (_string_): The the width of each range, or null to have Splunk calculate it.
         *    - `limit` (_string_): The maximum number of ranges to split into, or null for no limit.
         * @return {`splunkjs.Service.PivotSpecification`} The updated pivot specification.
         *
         * @method splunkjs.Service.PivotSpecification
         */
    ...
    root.DataModel = Service.Entity.extend({
         ...
         * @param {Object} props // TODO: list these params
