...
(function() {
     ...
     *          "boolean".
     *    - `_types`: {Array} Possible values for `type`.
    ...
    root.DataModelField = Class.extend({
        ...
        isObjectcount: function() {
            return "objectCount" === this.type; // TODO: is this supposed to be camelCased?
        },
        ...
        isChildcount: function() {
            return "childCount" === this.type; // TODO: is this supposed to be camelCased?
        },
    ...
    root.DataModelCalculation = Class.extend({
        ...
        init: function(props) {
            ...
            // TODO: add docs about conditional properties to class docs
        ...
        // TODO: the isX functions should speak to the SPL command being used instead, right?
        /**
    ...
    root.PivotSpec = Class.extend({
        // TODO: update the docs to "see class docs" for valid types, then add them to the class docs; same for any functions using them
        _comparisons: {
        ...
        addFilter: function(fieldName, comparisonType, comparison, compareTo) { // TODO: rename comparison to comparisonOp
            ...
            if (!utils.contains(this._comparisons[comparisonType], comparison)) {
                throw new Error(
                    "Cannot add " + comparisonType + 
            ...
            this.filters.push({
                ...
                type: comparisonType,
                toJsonObject: function() { // TODO: rename to toJsonObject
        ...
        addLimitFilter: function(fieldName, sortAttribute, sortDirection, limit, statsFunction) {
            ...
            if (this.dataModelObject.fieldByName(fieldName).type === "string" &&
            ...
            if (this.dataModelObject.fieldByName(fieldName).type === "number" &&
            ...
            if (this.dataModelObject.fieldByName(fieldName).type === "objectCount" &&
            ...
            this.filters.push({
                ...
                type: "number",
                toJsonObject: function() { // TODO: instead, conditionally define this filter, don't need this method
                    // add the common fields
                    var ret = {
                        fieldName: fieldName,
                        owner: this.dataModelObject.fieldByName(fieldName).lineage.join("."),
         ...
         * @param {String} label A human readable name for this set of rows.
         * // TODO: update docs to reflect the new ranges dict parameter
         ...
         *
         * @param {String} fieldName The field to split on.
         * // TODO: update docs for new ranges argument
         * @param {Number} start The value of the start of the first range, or null to take the lowest value in the events.
         * @param {Number} end The value for the end of the last range, or null to take the highest value in the events.
         * @param {Number} step The the width of each range, or null to have Splunk calculate it.
         * @param {Number} limit The maximum number of ranges to split into, or null for no limit.
        ...
        toJSON: function() { // TODO: rename to toJsonObject
            ...
            for (i = 0; i < this.filters.length; i++) {
                ret.filters = this.filters[i].toJsonObject();
            }
