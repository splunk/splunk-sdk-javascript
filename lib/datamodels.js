...
(function() {
    ...
    root.DataModel = Service.Entity.extend({
        ...
        // TODO: docs
        // Updates the entity just like you'd expect
        update: function(callback) {
            ...
            // TODO: cleanup keys not accepted by Splunk, and update/rename others
            if (!props.acceleration) {
                props.acceleration = {};
            }
            props.acceleration.enabled = props.accelerationEnabled;
            delete props.accelerationEnabled;
            props.acceleration.earliest_time = props.earliestTime;
            delete props.earliestTime;
            props.acceleration.cron_schedule = props.cronSchedule;
            delete props.cronSchedule;
            props.acceleration = JSON.stringify(props.acceleration);

            // TODO: reconstruct the entire JSON object that we want to update,
            //     : this included re-adding the data model objects, fields, etc
            //     : in the same format of JSON they were received.
            delete props._objectNames;
            ...
            props.description = {};
            //props.description = this.description().description;
            //props.description = JSON.stringify(props.description);
    ...
    root.DataModels = Service.Collection.extend({
        ...
        init: function(service) {
            ...
            this.concise = "0"; // TODO: check this, maybe move it somewhere else; or remove it?
