...
(function() {
        ...
        pivot: function(callback) {
            ...
            return svc.get(Paths.pivot + "/" + encodeURIComponent(this.dataModelObject.dataModel.name), args, function(err, response) {
                if (err) {
                    ...
                    // TODO: We want to return a Pivot object, should create a new class for it?
    ...
    root.DataModelObject = Class.extend({
         ...
         *
         * @return {Boolean} Whether this data model object is a BaseEvent.
         *
         * @method splunkjs.Service.DataModelObject
         */
         ...
         *
         * @return {Boolean} Whether this data model object is a BaseSearch.
         *
         * @method splunkjs.Service.DataModelObject
         */
         ...
         *
         * @return {Boolean} Whether this data model object is a BaseTransaction.
         *
         * @method splunkjs.Service.DataModelObject
         */
        ...
        /**
         * Starts a search job that fetches all the events of this data model object.
         *
         * @example
         *
         *      service.dataModels().fetch(function(err, dataModels) {
    ...
    root.DataModel = Service.Entity.extend({
        ...
        init: function(service, name, namespace, props) {
            ...
            this._JSON_labels = {
                ...
                description: "description", // The description key inside the JSON
                rawJSON: "description" // All of the JSON
            };
            ...
            this.acceleration = JSON.parse(props.content[this._JSON_labels.acceleration]) || {};
            ...
            var dataModelDescription = JSON.parse(props.content[this._JSON_labels.rawJSON]);

            this.objectNames = dataModelDescription.objectNameList || [];
            this.displayName = dataModelDescription[this._JSON_labels.displayName];
            this.description = dataModelDescription[this._JSON_labels.description];

            // Parse the objects for this data model           
            var objs = dataModelDescription.objects || [];
            this.objects = [];
