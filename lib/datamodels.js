...
(function() {
    ...
    root.PivotSpec = Class.extend({
        ...
        addLimitFilter: function(fieldName, sortAttribute, sortDirection, limit, statsFunction) {
            ...
            if (this.dataModelObject.fieldByName(fieldName).type === this.comparisonString &&
            ...
            if (this.dataModelObject.fieldByName(fieldName).type === this.comparisonNumber &&
            ...
            if (this.dataModelObject.fieldByName(fieldName).type === this.comparisonObjectCount &&
