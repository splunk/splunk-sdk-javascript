...
(function() {
        ...
        _invoke: function(action, method, args, callback) {
            ...
            return validateP.when(
                function() {
                    ...
                    var p = handler.apply(that.service, [path, args, callback]);
                    return p;
                },
        ...
        contains: function(id, callback) {
            ...
            return this.list().when(
                function(list) {
                    ...
                    return Promise.join(found, foundEntity);
                },
                generalErrorHandler(callback)
            );
        }
    ...
    root.SavedSearch = root.Entity.extend({
        ...
        acknowledge: function(callback) {
            var promise = this._invoke("acknowledge", "POST", {}, callback);
            this._invalidate();
        ...
        dispatch: function(callback) {
            var promise = this._invoke("dispatch", "POST", {}, callback);
            this._invalidate();
        ...
        history: function(callback) {
            var promise = this._invoke("history", "GET", {}, callback);
            this._invalidate();
        ...
        suppressInfo: function(callback) {
            var promise = this.get("suppress", {}, callback);
            this._invalidate();
