...
(function() {
    ...
    root.Job = root.Endpoint.extend({
        ...
        preview: function(params, callback) {
            return this.get("results_preview", params, function(response) { callback(response.odata.results); });
        },
        ...
        results: function(params, callback) {
            return this.get("results", params, function(response) { callback(response.odata.results); });
        },

        searchlog: function(params, callback) {
            return this.get("search.log", params, function(response) { callback(response.odata.results); });
        },
        ...
        summary: function(params, callback) {
            return this.get("summary", params, function(response) { callback(response.odata.results); });
        },

        timeline: function(params, callback) {
            return this.get("timeline", params, function(response) { callback(response.odata.results); });
        },
