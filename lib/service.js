...
(function() {
    ...
    module.exports = root = Service = Context.extend({
         ...
         *      - `owner`: The owner (username) component of the namespace.
         *      - `app`: The app component of the namespace.
         *      - `sessionKey`: The current session token.
         *      - `autologin`: `true` to automatically try to log in again if the session terminates, `false` if not (`true` by default).
         *      - `version`: The version string for Splunk, for example "4.3.2" (the default is "5.0").
         ...
         *
         * @param {String} owner The namespace owner.
         * @param {String} app The namespace app.
        ...
        /**
         * Creates a normal search that runs asynchronously with a given search 
        ...
        /**
         * Creates a oneshot search job from a given search query and optional parameters.
         *
         * @example
         *
         ...
         *      - `source`: The value to populate in the Source field for events from this data input.
         *      - `sourcetype`: The value to populate in the Sourcetype field for events from this data input.
