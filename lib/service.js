...
(function() {
    ...
    root.DataModel = root.Entity.extend({
        ...
        init: function(service, name, props) {
            ...
            // TODO: move all of this stuff into individual functions
            // // TODO: handle the case when acceleration is enabled, extracting the other fields
            // var rawJSON = JSON.parse(props.content[this._RAW_JSON_LABEL]);
            // this._properties.description = rawJSON[this._DESCRIPTION_LABEL];
            // this._properties.objectNames = rawJSON.objectNameList;
            this._super(service, this.path());
            // TODO: Probably don't need to do this once all parsing code is done
            ...
            // TODO: acceleration binding
            this.objects      = utils.bind(this, this.objects);
            this.objectByName = utils.bind(this, this.objectByName);
        },
        ...
        description: function() {
            return JSON.parse(this._properties[this._RAW_JSON_LABEL])[this._DESCRIPTION_LABEL];
        },
        ...
        displayName: function() {
            return this._properties[this._DISPLAY_NAME_LABEL];
        },
        ...
        objectByName: function(name) {
            ...
            for (var i = 0; i < this.objects().length; i++) {
                if (this.objects()[i].objectName === name) {
        ...
        create: function(name, params, callback) {
            ...
            return this.post("", {name: name, description: JSON.stringify(params)}, function(err, response) {
                if (err) {
                    ...
                    var dataModel = new root.DataModel(that.service, response.data.entry[0].name, response.data.entry[0].content);
