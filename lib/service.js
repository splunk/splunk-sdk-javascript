...
(function() {
    ...
    root.DataModelConstraint = Class.extend({
        ...
        init: function(props) {
            ...
            this._lineage       = props.ownerLineage;
        },
        // TODO: docs
        ownerLineage: function() {
            return this._lineage;
    ...
    root.DataModelCalculation = Class.extend({
        ...
        init: function(props) {
            ...
            for (var i = 0; i < props.outputFields.length; i++) {
                this._outputFields.push(new root.DataModelField(props.outputFields[i]));
            }
        },
    ...
    root.DataModel = root.Entity.extend({
        ...
        init: function(service, name, props) {
            ...
            for (var i = 0; i < objs.length; i++) {
                // TODO: this._objects = new root.DataModelObject(objs[i]);
                ...
                for (var f = 0; f < fields.length; f++) {
                    var field = fields[f];
                    objs[i]._fields[field.fieldName] = new root.DataModelField(field);
                }
                ...
                objs[i].allFields = function() {
                    ...
                    for (var c = 0; c < this.calculations().length; c++) {
                        ...
                        for (var f = 0; f < calc._outputFields.length; f++) {
                            ret[calc._outputFields[f].name] = calc._outputFields[f];
                        }
                    }
                    return ret;
                };
                ...
                for (var c = 0; c < constraints.length; c++) {
                    // TODO: test
                    objs[i]._constraints.push(constraints[c]);
                }
                ...
                for (var s = 0; s < calculations.length; s++) {
                    // TODO: test
                    objs[i]._calculations.push(new root.DataModelCalculation(calculations[s]));
                }
                ...
                objs[i].parent = function() {
                    return that.objectByName(this.parentName);
                };
            }
            this._objects = objs;
