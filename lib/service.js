...
(function() {
    ...
    root.Collection = root.Resource.extend({
         ...
         * @param {Object} namespace Namespace information:
         *    - `owner` (_string_): The Splunk username, such as "admin". A value of "nobody" means no specific user. The wildcard "-" is not acceptable when searching for an entity.
         *    - `app` (_string_): The app context for this resource (such as "search"). The wildcard "-" is unacceptable when searching for an entity.
         *    - `sharing` (_string_): A mode that indicates how the resource is shared. The sharing mode can be "user", "app", "global", or "system".
        ...
        item: function(id, namespace) {                
            ...
            if(namespace && (namespace.app === '-' || namespace.owner === '-')){
                throw("When searching for an entity, wildcard's are not allowed. Please reform your search.");
            }
