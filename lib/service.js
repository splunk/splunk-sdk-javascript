...
(function() {
    ...
    root.Job = root.Entity.extend({
        ...
        /**
         * Returns an iterator over this search job's results.
         * 
         * @param {Object} params A dictionary of optional parameters:
         ...
         * @method splunkjs.Service.Job
         */
        resultsIterator: function(params) {
            return new root.PaginatedEndpointIterator(this.results, params);
        },
            ...
            Async.whilst(
                ...
                function(nextIteration) {
                    that.fetch(function(err, job) {
                        ...
                        if (!emittedReady) {
                            if (dispatchState) {
                                (callbacks.ready || function() {})(job);
                                emittedReady = true;
                            }
                        }
                        if (emittedReady) {
                            (callbacks.progress || function() {})(job);
                            
                            if (dispatchState === "DONE") {
                                (callbacks.done || function() {})(job);
