...
(function() {
    ...
    root.DataModel = root.Entity.extend({
        ...
        init: function(service, props) {
            ...
            // var objectsFromJSON = parseObjects(rawJSON.objects);
            // this._properties._objects = objectsFromJSON;
    ...
    root.DataModels = root.Collection.extend({
        ...
        create: function(name, params, callback) {
            ...
            return this.post("", {name: name, description: JSON.stringify(params)}, function(err, response) {
                if (err) {
                    ...
                    var dataModel = new root.DataModel(that.service, response.data.entry[0].content, that.path());
         ...
         */
         instantiateEntity: function(props) {
            return new root.DataModel(this.service, props);
         }
    });
