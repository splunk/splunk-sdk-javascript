...
(function() {
    ...
    root.SavedSearch = root.Entity.extend({
         ...
         *
         *      var savedSearch = service.savedSearches().item("MySavedSearch");
         *      savedSearch.history(function(err, firedAlerts, search) {
         *          for(var i = 0; i < firedAlerts.length; i++) {
         *              console.log("Fired alerts", i, ":", firedAlerts[i].sid);
         *          }
         *      });
         *
         * @param {Function} callback A function to call when the history is retrieved: `(err, firedAlerts, savedSearch)`.
         *
        ...
        history: function(callback) {
            ...
            return this.get("history", {}, function(err, response) {
                ...
                for(var i = 0; i < data.length; i++) {
                    ...
                    var firedAlert = new root.Job(that.service, firedAlertData.name, namespace);
