...
(function() {
    ...
    root.DataModel = root.Entity.extend({
        ...
        init: function(name, service, path) {
            ...
            // Constants
            this._ACCELERATION_LABEL = "accleration";
            ...
            this._objects = {};
            this._accelerationEnabled = this._earliestAcceleratedTime = this._accelerationCronSchedule = undefined;
    ...
    root.DataModels = root.Collection.extend({
         ...
         */
         instantiateEntity: function(props) {
            var entityNamespace = utils.namespaceFromProperties(props);
            return new root.DataModel(props.name, this.service, this.path());
         }
    });
