...
(function() {
    ...
    root.StoragePassword = root.Entity.extend({
         ...
         */
        path: function () {
            return Paths.storagePassword + "/" + encodeURIComponent(this.name);
        },
    ...
    root.StoragePasswords = root.Collection.extend({
         ...
         *
         * @param {Object} props The properties for the new storage password. For a list of available parameters, see <a href="http://docs.splunk.com/Documentation/Splunk/latest/RESTAPI/RESTaccess#POST_storage.2Fpasswords" target="_blank">POST storage/passwords</a> on Splunk Developer Portal.
