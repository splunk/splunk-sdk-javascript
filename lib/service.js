...
(function() {
     ...
     *    - `inputFieldMappings` (_array_): TODO: need a label; this is a 1 element array containing a dictionary
     *
     ...
     *    - `groupByFields` (_string_): The fields to group results by
     *    - `objectsToGroup` (_array_): TODO: need a label
    ...
    root.DataModelObject = Class.extend({
         ...
         *     - `groupByFields` (_array_): The fields to group results by; exclusive to BaseTransaction (optional)
         *     - `objectsToGroup` (_array_): TODO: need a label; exclusive to BaseTransaction (optional)
