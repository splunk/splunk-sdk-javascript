        ...
        init: function(service, name, props) {
            ...
            for (var i = 0; i < objs.length; i++) {
                ...
                objs[i].parent = function() {
                    return that.objectByName(curObj.parentName) || null;
                };
            }
            this._objects = objs;

            // TODO: function binding, for async function
            // this.description  = utils.bind(this, this.description);
            // this.displayName  = utils.bind(this, this.displayName);
            // this.objects      = utils.bind(this, this.objects);
            // this.hasObject    = utils.bind(this, this.hasObject);
