...
(function() {
        ...
        create: function(query, params, callback) {
            ...
            return this.post("", params, function(err, response) {
                if (err) {
                    ...
                    job.query = query; // TODO: document this change
                    callback(null, job);
                }
            });
        },
    ...
    root.DataModelField = Class.extend({
        // TODO: docs
        init: function(props) {
            this.name           = props.fieldName || props.name;
    ...
    root.DataModelConstraint = Class.extend({
        ...
        init: function(props) {
            ...
            // TODO: props.lineage may be an array, which I should split; might need different functions
    ...
    root.DataModelCalculation = Class.extend({
        ...
        init: function(props) {
            ...
            for (var i = 0; i < props.outputFields.length; i++) {
                // TODO: any cases where the name isn't "name", but "fieldName", etc. do a renaming
    ...
    root.DataModelObject = Class.extend({
        ...
        init: function(props, parentDataModel) {
            ...
            // TODO: this stuff, and some other properties for all objects
            ...
            for (var i = 0; i < props.constraints.length; i++) {
                this._constraints.push(new root.DataModelConstraint(props.constraints[i]));
            }

            // Parse calculations
            this._calculations = [];
            for (var i = 0; i < props.calculations.length; i++) {
                //this._calculations.push(new root.DataModelCalculation(props.calculations[i]));
                this._calculations[props.calculations[i].calculationID] = new root.DataModelCalculation(props.calculations[i]);
            }
        ...
        allFields: function() {
            ...
            for (var i in calculatedFields) {
                // TODO: hasOwnPropertyCheck won't allow them to pass through...?
                var calculatedField = calculatedFields[i];
        ...
        createLocalAccelerationJob: function(earliestTime, callback) {
            ...
            if (utils.isFunction(earliestTime)) {
            ...
            // TODO: figure out why service() isn't a function
