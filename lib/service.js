...
(function() {
    ...
    module.exports = root = Service = BaseService.extend({
        ...
        /** TODO: revise
         * Gets the `FiredAlerts` collection, 
         * 
         * @example
         *      
         *      // List saved searches
     ...
     * searches usi
     ng this collection container, or get a specific saved search.
     *
     *
     * @endpoint saved/searches
    ...
    root.AlertGroup = root.Entity.extend({
         ...
         */
        count: function() {
            return this._properties.triggered_alert_count;
        },

        /**TODO: cleanup docs, and implement the item method for FiredAlerts
         * Retrieves the job history for a saved search, which is a list of 
         * `splunkjs.Service.Job` instances.
         *
         * @example
    ...
    root.FiredAlerts = root.Collection.extend({
        ...
        /**
         * Creates a local instance of a fired alert.
         *
         * @param {Object} props The properties for the fired alert.
         * @return {splunkjs.Service.AlertGroup} A new `splunkjs.Service.AlertGroup` instance.
         *
         * @method splunkjs.Service.FiredAlerts
         */
