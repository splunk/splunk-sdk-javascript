...
(function() {
    ...
    root.DataModel = root.Entity.extend({
        ...
        init: function(service, name, props) {
            ...
            // this._properties._accelerationEnabled = JSON.parse(props.content[this._ACCELERATION_LABEL])["enabled"]
            // // TODO: handle the case when acceleration is enabled, extracting the other fields
            // this._properties.displayName = props.content[this._DISPLAY_NAME_LABEL];
        ...
        description: function() {
            return JSON.parse(this._properties.description).description;
        },
         ...
         */
        objects: function() {
            // TODO: clean this up without the util function.
            ...
            if (!JSON.parse(this._properties.description).objects) {
                return [];
            }
            return parseObjects(JSON.parse(this._properties.description).objects);
        },
