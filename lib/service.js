...
(function() {
    ...
    // This require must be invoked after collection and entity are defined.
    // TODO: do some testing with browsers to see how this require works, it might easily break
    //     : things due to async loading of these modules and the fact that they might load out of order
    //     : which means that the Entity & Collection classes might not be loaded yet at this point.
    var DataModels              = require('./datamodels');
    root.DataModelField         = DataModels.DataModelField;
    root.DataModelConstraint    = DataModels.DataModelConstraint;
    root.DataModelCalculation   = DataModels.DataModelCalculation;
    root.DataModelObject        = DataModels.DataModelObject;
    root.DataModel              = DataModels.DataModel;
    root.DataModels             = DataModels.DataModels;
