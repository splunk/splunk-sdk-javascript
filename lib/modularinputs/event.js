...
(function() {
    ...
    *
    * @param {Object} buffer A `Buffer` object to write this `Event` to.
    * @param {Number} offset The offset position in the `Buffer` to begin writing.
    * @param {Function} callback The function to call after writing: `(err, definition)`.
    * @class splunkjs.modularinput.Event
    */
