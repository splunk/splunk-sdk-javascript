...
(function() {
     ...
     * `</input>`
     *
     * @param {String} string containing XML to parse.
     * @param {Function} callback The function to call after parsing: `(err, definition)`.
     *
     * @class splunkjs.modularinput.InputDefinition
     */
    InputDefinition.parse = function(str, callback) {
        try {
