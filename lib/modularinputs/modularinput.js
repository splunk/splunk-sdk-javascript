...
(function() {
    ...
    ModularInput.runScript = function(exports, args, eventWriter, inputStream, callback) {
        ...
        if (args.length === 1) {
            // After waiting 30 seconds for input definitions, assume something bad happened
        ...
        // When validating arguments...
            ...
            // After waiting 30 seconds for a validation definition, assume something bad happened
