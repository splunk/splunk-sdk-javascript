...
(function() {
        ...
        if (args.length === 1) {
            ...
            inputStream.on("data", function(chunk) {
                ...
                if (typeof chunk === "string"){
                    var temp = new Buffer(chunk.length+1);
                    temp.write(chunk);
                    bigBuff = Buffer.concat([bigBuff, temp]);
                }
                else {
            ...
            // TODO: how can these be combined?
            if (!scheme) {
                Async.chain([
                        function (done) {
    ...
    // Default to empty functions for life cycle events; TODO: add docstrings; all are optional
    ...
    // Once the streaming ends, for an input (upon successfully streaming all events)
    ...
    ModularInput.execute = function(exports, module) {
        ...
        Async.chain([
                ...
                function(done) {
                    ModularInput.runScript(exports, args, ew, process.stdin, done);
                },
                function(status, done) {
                    scriptStatus = status;
            ...
            function(err) {
                // TODO: Do I need to do any logging after execution, specifically on error?
