...
(function() {
    ...
    * Calls the provided callback with an error, and the `Buffer` written to.
    *
    * @param {Object} an `Event` Object.
    * @param {Object} a callback function.
    * @class splunkjs.modularinput.EventWriter
    */
    ...
    * @param {Function} a callback function to call after logging the message.
    * @class splunkjs.modularinput.EventWriter
    */
    EventWriter.prototype.log = function(severity, message, callback) {
        try {
            var err = severity + " " + message + "\n";
            this._err.write(err, this.errPosition);
    ...
    * this._out `Buffer`.
    *
    * @param {Object} an `Elementtree` Object representing an XML document.
    * @param {Function} a callback function to call after writing the XML document.
    * @class splunkjs.modularinput.EventWriter
    */
    EventWriter.prototype.writeXMLDocument = function(xmlDocument, callback) {
        try {
            ...
            // TODO: clean this up when sorting out Buffer situation.
            ///*
                this._out.write(xmlString); // For streams/sockets, testing
            //*/
            //this._out.write(xmlString, this.outPosition);
            this.outPosition += xmlString.length;
            callback();
        }
        catch (e) {
            callback(e);
    ...
    *
    * @param {Function} a callback function to call after writing </stream>.
    * @class splunkjs.modularinput.EventWriter
    */
