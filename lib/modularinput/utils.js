 ...
 *   `</configuration>`
 *
 * @param {Object} an elementtree.element object representing the `<configuration>` XML node.
 * @return {Object} an elementtree.element object representing the parameters of node passed in.
 */
...
utils.XMLCompare = function(expected, found) {
    ...
    if (!utils.deepEquals(expected.getchildren(), found.getchildren())) {
        return false;
    }
