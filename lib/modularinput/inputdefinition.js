                                ...
                                if (property === "$") {
                                    ...
                                    for (var singleValue in property) {
                                        if (input[property][singleValue]) {
                                            var propertyName = input[property][singleValue]["$"].name;
                                            that.inputs[name][propertyName] = input[property][singleValue]["_"];
                                        }
                                    }
                                }
                                    ...
                                    for (var multiValue in input[property]) {
                                        if (input[property][multiValue]) {
                                            var propertyName = input[property][multiValue]["$"].name;
                                            that.inputs[name][propertyName] = input[property][multiValue].value;
                                        }
                                    }
                                }
                            }
