...
(function() {
    ...
    InputDefinition.prototype.equals = function(other) {
        ...
        return (utils.deepEquals(other.metadata, this.metadata) && 
            utils.deepEquals(other.inputs, this.inputs));
    };
     ...
     * @class splunkjs.modularinput.InputDefinition
     */
    InputDefinition.parse = function(stream, callback) {
        ...
        try {
            parser.parseString(stream, function(err, result) {
                ...
                if (!root) {
                    throw new Error("Invalid input definition scheme.");
                }
                    ...
                    if (root.hasOwnProperty(key)) {
                        ...
                        if (key === "configuration") {
                            ...
                            if (typeof configuration === "string") {
                                ...
                                try {
                                    definition.inputs = parseStanzas(stanzas);
                                }
                                catch (e) {
                                    throw e;
                                }
    ...
    function parseStanzas(stanzas) {
        ...
        utils.forEach(stanzas, function(input) {
            ...
            try {
                inputs[inputName] = utils.parseParameters(input);
            }
            catch (e) {
                throw e;
            }
