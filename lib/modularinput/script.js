...
(function() {
     ...
     * @return {Number} An integer to be used as the exit value of this script. //TODO: there is no callback
     * @class splunkjs.modularinput.Script
     */
     // TODO: update docstrings
    Script.runScript = function(exports, args, eventWriter, inputStream, callback) {
        var that = this;
     ...
     *
     * @return {Object} A `Splunkjs.Service` Object, or null if you call this function before the `Script.streamEvents` function is called.
     * @class splunkjs.modularinput.Script
     */
    ...
    //TODO: default to empty functions for life cycle events; add docstrings; all are optional
    // Before streaming begins
    Script.prototype.setup = function(done) {
        done();
    };
    // Once the streaming starts, for an input
    Script.prototype.start = function(name, definition, done) {
        done();
    };
    // Once the streaming ends, for an input
    Script.prototype.end = function(name, definition, done) {
        done();
    };
    // After all streaming is done for all inputs
    Script.prototype.teardown = function(done) {
        done();
    };
     ...
     *
     * @param {Object} exports An instance of Script representing a modular input
     * @param {Object} module An instance of Script representing a modular input
     * @class splunkjs.modularinput.Script
     */
    // TODO: testing, docstrings, remove run()?
    Script.execute = function(exports, module) {
        ...
        exports.setup       = exports.setup     || Script.prototype.setup;
        exports.start       = exports.start     || Script.prototype.start;
        exports.end         = exports.end       || Script.prototype.end;
        exports.teardown    = exports.teardown  || Script.prototype.teardown;
        ...
        Async.chain([
                ...
                function(done) {
                    Script.runScript(exports, args, new EventWriter(), process.stdin, done);
                },
                function(status, done) {
                    scriptStatus = status;
