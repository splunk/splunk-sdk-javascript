...
(function() {
     ...
     *
     * @param {Array} args List of command line arguments passed to this script.
    ...
    Script.prototype.run = function(args) {
        ...
        return this.runScript(args, new EventWriter(), process.stdin);
    };
     ...
     * @class splunkjs.modularinput.Script
     */
    Script.prototype.runScript = function(args, eventWriter, inputStream) {
        var that = this;
