...
(function() {
    ...
    module.exports = root = Http = Class.extend({
        ...
        get_v2: function(url, headers, params, timeout) {
            var message = {
                method: "GET",
                headers: headers,
                timeout: timeout,
            ...
            return this.request_v2(url, message);
        },
        ...
        request_v2: function(url, message) {
            var that = this;
            var query = utils.getWithVersion(this.version, queryBuilderMap)(message);
            var post = message.post || {};
            ...
            // Now we can invoke the user-provided HTTP class,
            // var res_2 = await this.makeRequest_v2(encodedUrl, options);
            // console.log(res_2.body.entry[0]);
            return this.makeRequest_v2(encodedUrl, options);
        },
