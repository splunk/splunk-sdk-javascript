...
(function() {
    ...
    var CookieHandler   = require('tough-cookie');
    ...
    module.exports = root = Http = Class.extend({
        ...
        init: function() {
            ...
            // Cookie store for cookie based authorization.
            this._cookieStore = {};
        },
        ...
        request: function(url, message, callback) {
            ...
            var wrappedCallback = function(response) {
                ...
                if (cookieHeader) {
                    var cookie = CookieHandler.parse(cookieHeader.toString());
            ...
            for (var key in this._cookieStore) {
                cookieString += key;
                cookieString += '=';
                cookieString += this._cookieStore[key];
                cookieString += '; ';
            }
            ...
            if (cookieString.length !== 0) {
                ...
                // Splunk Core will use Authorization header and ignore Cookies if Authorization header is sent
