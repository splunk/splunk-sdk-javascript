...
exports.setup = function () {
    ...
    return {
        "Callback#callback to object success": function (done) {
        ...
        "Callback#callback to object error - single argument": function (done) {
            var successfulFunction = function (callback) {
                callback("one");
            };
        ...
        "Callback#callback to object error - multi argument": function (done) {
            var successfulFunction = function (callback) {
                callback(["one", "two"]);
            };
        ...
        "isArray": function (done) {
            var a = [1, 2, 3, 4, 5];
            assert.ok(splunkjs.Utils.isArray(a));
            done();
        },

        "isFunction": function (done) {
        ...
        "namespaceFromProperties": function (done) {
        ...
        "namespaceFromProperties - bad data": function (done) {
            var undefinedProps;
