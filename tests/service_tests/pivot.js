...
exports.setup = function (svc) {
    return {
        ...
        "Callback#Pivot - test constructor args": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test acceleration, then pivot": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test illegal filtering (all types)": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test boolean filtering": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test string filtering": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test IPv4 filtering": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test number filtering": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test limit filtering": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test row split": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test column split": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test cell value": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test pivot throws HTTP exception": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test pivot with simple namespace": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#Pivot - test pivot column range split": function (done) {
        ...
        "Callback#Pivot - test pivot with PivotSpecification.run and Job.track": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - delete any remaining data models created by the SDK tests": function (done) {
            if (this.skip) {
                done();
                return;
            }
