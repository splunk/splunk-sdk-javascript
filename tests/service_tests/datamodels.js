...
module.exports = function (svc) {
    return {
        ...
        "Callback#DataModels - fetch a built-in data model": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create & delete an empty data model": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create a data model with spaces in the name, which are swapped for -'s": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create a data model with 0 objects": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create a data model with 1 search object": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create a data model with 2 search objects": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - data model objects are created correctly": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - data model handles unicode characters": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create data model with empty headers": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test acceleration settings": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model object metadata": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model object parent": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model object lineage": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model object fields": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model object properties": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create local acceleration job": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - create local acceleration job with earliest time": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model constraints": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - test data model calculations, and the different types": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - run queries": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - baseSearch is parsed correctly": function (done) {
            if (this.skip) {
                done();
                return;
            }
        ...
        "Callback#DataModels - baseTransaction is parsed correctly": function (done) {
            if (this.skip) {
                done();
                return;
            }
